...
$this->pageTitle=Yii::app()->name . ' - 珠海校区课室介绍';
...
?>
<div id="zhuhaiLeft">
<table class="item table table-striped table-bordered table-condensed tableCenter"  id="zhuhaiB">
   <caption><strong>珠海校区B栋</strong></caption>
   <tbody><tr>
       <th>二楼</th>
       <th>三楼</th>
       <th>四楼</th>
...
<table class="item table table-striped table-bordered table-condensed tableCenter"  id="zhuhaiD">
    <caption><strong>珠海校区D栋</strong></caption>
    <tbody><tr>
        <th>二楼</th>
        <th>三楼</th>
        <th>四楼</th>
...
<div  id="zhuhaiRight">
<table class="item table table-striped table-bordered table-condensed tableCenter" id="zhuhaiC">
    <caption><strong>珠海校区C栋</strong></caption>
    <tbody><tr>
        <th>二楼</th>
        <th>三楼</th>
        <th>四楼</th>
...
<table class="item table table-striped table-bordered table-condensed tableCenter" id="zhuhaiE">
    <caption><strong>珠海校区E栋</strong></caption>
    <tbody><tr>
        <th>二楼</th>
        <th>三楼</th>
        <th>四楼</th>
...
<table class="item table table-striped table-bordered table-condensed tableCenter"  id="zhuhaiF">
     <caption><strong>珠海校区F栋</strong></caption>
     <tbody><tr>
         <th>二楼</th>
         <th>三楼</th>
         <th>五楼</th>
