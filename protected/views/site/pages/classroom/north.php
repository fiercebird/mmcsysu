...
$this->pageTitle=Yii::app()->name . ' - 北校区课室介绍';
...
?>
<div class='row-fluid'>
<table class="item table table-striped table-bordered table-condensed tableCenter"  id="north1">
        <caption><strong>北校区教学大楼</strong></caption>
            <tbody><tr>
                <th scope="col">一楼</th>
                <th scope="col">二楼</th>
                <th scope="col">三楼</th>
...
<div class="row-fluid">
<table class="item table table-striped table-bordered table-condensed tableCenter" id="north2">
            <caption><strong>北校区其他教室</strong></caption>
            <tbody><tr>
                <th>寄生虫楼</th>
                <th>何母楼</th>
                <th>永生楼</th>
