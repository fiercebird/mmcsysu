...
$this->pageTitle=Yii::app()->name . ' - 南校区课室介绍';
...
?>
<div class='row-fluid'>
<table class="item table table-striped table-bordered table-condensed tableCenter" id="south1" >
    <caption><strong>南校区逸夫楼<strong></caption>
    <tbody><tr>
        <th scope="col">二楼</th>
        <th scope="col">三楼</th>
        <th scope="col">四楼</th>
...
<table class="item table table-striped table-bordered table-condensed tableCenter" id="south2">
    <caption><strong>第一教学楼</strong></caption>
    <tbody><tr>
        <th scope="col">一楼</th>
        <th scope="col">二楼</th>
        <th scope="col">三楼</th>
...
<br />
<div class='row-fluid'>
<table class="item table table-striped table-bordered table-condensed tableCenter" id="south3">
    <caption><strong>文科楼</strong></caption>
    <tbody><tr>
        <td><a href="#">101</a></td>
        <td><a href="#">102</a></td>
        <td><a href="#">103</a></td>
...
<br />
<div class='row-fluid'>
<table class="item table table-striped table-bordered table-condensed tableCenter" id="south4">
    <caption><strong>第二、三教学楼</strong></caption>
    <tbody><tr>
