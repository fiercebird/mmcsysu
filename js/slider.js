...
var PImgPlayer = {
    ...
    init: function (objID, w, h, time) {
        ...
        var ulStyle2 = "margin:0 0;line-height:25px;width:" + w + "px;position:absolute;overflow:hidden;bottom:-1px;height:24px; border-right:1px solid #fff;font-size:14px;font-weight:bold;text-align:center;background:#fff;";
        //   
